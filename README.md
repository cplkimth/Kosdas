...
- 실시간 가격 정보
- 가격 정보
- .Net Standard 2.0 지원 (닷넷 프레임워크와 닷넷 코어에서 사용 가능)
- 병렬 LINQ를 활용하여 고성능 구현
...
```
- 완전한 사용 방법은 [단위 테스트 코드](/Kosdas.UnitTestProject/StockLoaderTests.cs)에서 확인할 수 있습니다.
