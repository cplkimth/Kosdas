...
namespace Kosdas.UnitTest
{
    ...
    public class PriceLoaderTests
    {
        ...
        {
            var price = PriceLoader.Naver.Load(StockBase.아이퀘스트, 2021, 2, 26);
        ...
        {
            var prices = PriceLoader.Yahoo.Load(StockBase.삼성전자, new DateTime(2018,5,3), new DateTime(2018,5,4)).ToList();
